...
<head>
    ...
    <title>زندر | منصة التسويق عبر واتساب وإدارة الأعمال المتكاملة</title>
    <meta name="description"
        content="اكتشف زندر، الحل الأمثل لأتمتة رسائل واتساب، إدارة علاقات العملاء، وإنشاء متجرك الإلكتروني. ضاعف مبيعاتك ونظم أعمالك بسهولة مع منصتنا الشاملة.">
    <meta name="keywords"
        content="زندر, تسويق واتساب, whatsapp marketing, إدارة عملاء, CRM, متجر إلكتروني, أتمتة رسائل, zender">
    <meta name="author" content="Zender">
    ...
    <meta property="og:title" content="زندر | منصة التسويق عبر واتساب وإدارة الأعمال المتكاملة">
    <meta property="og:description"
        content="اكتشف زندر، الحل الأمثل لأتمتة رسائل واتساب، إدارة علاقات العملاء، وإنشاء متجرك الإلكتروني. ضاعف مبيعاتك ونظم أعمالك بسهولة.">
    <meta property="og:image" content="{{ asset('favicon.png') }}">
    <meta property="og:locale" content="ar_AR">
    <meta property="og:site_name" content="زندر - Zender">

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="{{ url()->current() }}">
    <meta name="twitter:title" content="زندر | منصة التسويق عبر واتساب وإدارة الأعمال المتكاملة">
    <meta name="twitter:description"
        content="اكتشف زندر، الحل الأمثل لأتمتة رسائل واتساب، إدارة علاقات العملاء، وإنشاء متجرك الإلكتروني.">
    ...
    <script type="application/ld+json">
        {
            ...
            "operatingSystem": "Web",
            "description": "منصة متكاملة للتسويق عبر واتساب وإدارة علاقات العملاء وإنشاء المتاجر الإلكترونية",
            "url": "{{ url('/') }}",
            "offers": {
                "@type": "Offer",
                "price": "0",
